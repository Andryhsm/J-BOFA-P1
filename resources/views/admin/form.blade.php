        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center user_name">{{ $user ? $user->first_name : '' }} {{ $user ? $user->last_name : '' }}</h3>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
            ...
            <div class="tab-content">            
              ...
              <div class="tab-pane active" id="settings">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <input type="text" name="inputName" class="form-control" id="inputName" placeholder="Nom" value="{{ $user ? (isset($user->last_name) ? $user->last_name: '') : '' }}">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputName" class="col-sm-3 control-label">Pr&eacute;nom</label>
                    <div class="col-sm-9">
                      <input type="text" name="first_name" class="form-control" id="first_name" placeholder="Prenom" value="{{ $user ? (isset($user->first_name) ? $user->first_name: '') : '' }}">
                    </div>
                  </div>
                  <div class="form-group">
