                    ...
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-light full-width">
                            <div class="flex-one d-flex align-items-center">
                                ...
                                <a class="navbar-brand site-name" href="{{ (Auth::user()) ? Url('/artisan/accueil') : Url('/') }}" style="font-size: 36px;">e-artisans.fr</a>
                                <a class="email_box d-flex align-items-center justify-content-center flex-one" href="tel:{{$contact->phone}}">
                                  <label for="" class="email item_box_header">
